...
## Iterations
[Updated prototype after iterations](https://www.figma.com/proto/z54ICsJrQt9zH6RaddcoiY/Final-Prototype?page-id=0%3A1&type=design&node-id=1-201&viewport=214%2C100%2C0.26&scaling=scale-down&starting-point-node-id=1%3A201)
I mainly added more back and forward flows, and made the prototype much more user friendly by merging all the flows (task 1 flow and task 2-4 flows) into one so users can complete all the tasks starting from the same flow. I did this because my classmates were confused as to which flow to start from and wanted to explore the app all at once. Now the app should feel more explorable and easy to navigate with all the flows connected to each other and not separated by task like before. <br>
...
## Reflection
Overall, this process was very insightful and an important reminder that design-informed research is a constant and cyclical process. It's vital to document and iterate over and over to make further improvements to the design and user interface. The cognitive walkthrough in addition to creating the high-fidelity prototype gave me more confidence about my design and informed me about more possible directions. It's always great to get feedback and understand my users more. <br>
Based on my feedback, I would possibly add more help documentation that would unobscure features that first-time users might not know about on their first glance. One of my users also suggested adding different views for the archives, switching between the timeline and the full-screen views. I would also want to explore adding flows to the search bars for the archives (particularly giving the user to search and filter through the archives to complete the scanning task). 
