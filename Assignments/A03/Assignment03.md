...
Creating a script for the contextual inquiry was quite difficult because I couldn't expect how the user would interpret the questions, which I tried to keep as vague yet directed towards family memories as possible. The topic did tend to shift towards photo storage between physical or digital, so I tried to go off script and re-center the focus on family. If I were to do this again, I would try to ask fewer background questions which I felt took up most of the time, and spend more time on observing the user's activities. I alos felt I should've done an activity involving Google Photos, and asked them how they would organize and create some sort of family archive. Overall, this contextual inquiry was humbling and helped me deeply connect more with how users feel about the concept of "family" and "memories".
